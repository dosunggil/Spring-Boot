...
public class UserVO implements UserDetails {
    ...
    /*
        ...
        => strSet 에는 2개의 데이터만 존재한다.

        Set 을 생성할 때 HashSet 을 사용하면 데이터가 add 한 순서대로 저장되지 않는다.
        add 한 데이터의 순서를 보장하려면
        Set<String> strSet = new LinkedHashSet<String>() 을 사용하여 객체를 초기화해야 한다.
     */
